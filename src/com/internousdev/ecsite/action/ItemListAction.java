...
public class ItemListAction extends ActionSupport implements SessionAware{
	...
	public String execute() throws SQLException{
		...
		//ItemListDAOを呼び出す
		//itemListDAOのgetItemInfoList(DBの商品情報)をitemInfoDTOListに代入
		//itemInfoDTOListの要素が0より大きくなかったらnullになり、
		//itemListJSPで「商品情報はありません」の表示になる

		ItemListDAO itemListDAO = new ItemListDAO();
		itemInfoDTOList = itemListDAO.getItemInfoList();
